...
export const Dashboard = () => {
  ...
  if (!isLoaded) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-900 via-black to-black">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br rounded-xl from-blue-900 via-black to-black text-white">
        {/* Top header */}
          ...
          <main className="lg:col-span-3">
            <div className="bg-white/3 border border-white/6 rounded-2xl p-6 min-h-[56vh]">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-lg font-semibold">Welcome back{user?.firstName ? `, ${user.firstName}` : ""}.</h2>
